		...
		<div class="entry-cat">
			...
			ob_start();
				if ( has_post_thumbnail() ) {
					...
					<a href="<?php the_permalink(); ?>" title="<?php the_title();?>"><img src="<?php bloginfo('template_url'); ?>/images/bg_dummy.gif" width="175" height="70" alt="<?php the_title();?>" /></a>
			<?php }
			$total_thumb = ob_get_contents();
			ob_end_clean();
			
			get_vid_thumb($total_thumb, 'video-category');
			?>
